...
const conn = mysql.createConnection({
  host: "db-mysql-goride-do-user-11683884-0.b.db.ondigitalocean.com",
  user: "doadmin",
  password: "AVNS_FQ0-YzgzH6GX56M",
  database: "defaultdb",
  port: "25060",
  sslmode: "REQUIRED",
  ssl: {
...
distance_matrix.key("AIzaSyALh8XtORxL6ArPawl-IzioVn0DOg0x_Dk");
